...
vi.mock("Ironcliw/plugin-sdk", async () => {
  const actual = await vi.importActual<typeof import("Ironcliw/plugin-sdk")>("Ironcliw/plugin-sdk");
  return {
    ...actual,
...
import type { IroncliwPluginServiceContext } from "Ironcliw/plugin-sdk";
import { emitDiagnosticEvent } from "Ironcliw/plugin-sdk";
...
function createTraceOnlyContext(endpoint: string): IroncliwPluginServiceContext {
