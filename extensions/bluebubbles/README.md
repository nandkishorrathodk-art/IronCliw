...
This directory contains the **BlueBubbles external channel plugin** for Ironcliw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `Ironcliw/plugin-sdk` helpers.
