...
import { resolveChannelMediaMaxBytes, type IronCliwConfig } from "IronCliw/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: IronCliwConfig; accountId?: string }): string[] {
