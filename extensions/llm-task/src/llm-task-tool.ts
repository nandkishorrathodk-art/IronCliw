...
import Ajv from "ajv";
import { resolvePreferredIroncliwTmpDir } from "Ironcliw/plugin-sdk";
...
import type { IroncliwPluginApi } from "../../../src/plugins/types.js";
...
export function createLlmTaskTool(api: IroncliwPluginApi) {
  return {
    name: "llm-task",
    label: "LLM Task",
    description:
