...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("Ironcliw/plugin-sdk").IroncliwConfig;
    runtime: import("Ironcliw/plugin-sdk").RuntimeEnv;
  };
  log?: (msg: string) => void;
}) {
 ...
 */
export function registerSlashCommandRoute(api: IroncliwPluginApi) {
