import type { IronCliwConfig, PluginRuntime, ResolvedLineAccount } from "ironcliw/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: IronCliwConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: IronCliwConfig; accountId: string }): Promise<{
