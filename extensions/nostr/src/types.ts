...
function resolveConfiguredDefaultNostrAccountId(cfg: IronCliwConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: IronCliwConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: IronCliwConfig): string {
