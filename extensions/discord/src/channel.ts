import { createScopedChannelConfigBase } from "ironcliw/plugin-sdk/compat";
import {
...
} from "ironcliw/plugin-sdk/compat";
import {
...
export const discordPlugin: ChannelPlugin<ResolvedDiscordAccount> = {
  ...
  agentPrompt: {
    messageToolHints: () => [
      ...
      "- Forms: add `components.modal` (title, fields). IronCliw adds a trigger button and routes submissions as new messages.",
    ],
  },
  messaging: {
