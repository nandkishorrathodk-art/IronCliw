...
function mergeZaloAccountConfig(cfg: IronCliwConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: IronCliwConfig): ResolvedZaloAccount[] {
