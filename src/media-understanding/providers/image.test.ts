...
const ensureIronCliwModelsJsonMock = vi.fn(async () => {});
...
vi.mock("../../agents/models-config.js", () => ({
  ensureIronCliwModelsJson: ensureIronCliwModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    expect(ensureIronCliwModelsJsonMock).toHaveBeenCalled();
