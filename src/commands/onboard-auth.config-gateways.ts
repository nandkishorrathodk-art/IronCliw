...
export function applyVercelAiGatewayProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
...
export function applyVercelAiGatewayConfig(cfg: IroncliwConfig): IroncliwConfig {
