...
export function applyOpenrouterProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: IroncliwConfig): IroncliwConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: IroncliwConfig): IroncliwConfig {
...
export function applyMoonshotConfig(cfg: IroncliwConfig): IroncliwConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: IroncliwConfig): IroncliwConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: IroncliwConfig): IroncliwConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: IroncliwConfig): IroncliwConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: IroncliwConfig): IroncliwConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: IroncliwConfig): IroncliwConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: IroncliwConfig): IroncliwConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: IroncliwConfig): IroncliwConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: IroncliwConfig): IroncliwConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: IroncliwConfig): IroncliwConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: IroncliwConfig): IroncliwConfig {
...
export function applyQianfanProviderConfig(cfg: IroncliwConfig): IroncliwConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: IroncliwConfig): IroncliwConfig {
