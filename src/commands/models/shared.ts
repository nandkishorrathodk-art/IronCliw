...
export async function loadValidConfigOrThrow(): Promise<IronCliwConfig> {
...
export async function updateConfig(
  mutator: (cfg: IronCliwConfig) => IronCliwConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: IronCliwConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: IronCliwConfig): Set<string> {
