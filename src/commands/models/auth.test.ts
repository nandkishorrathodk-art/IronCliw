...
describe("modelsAuthLoginCommand", () => {
  ...
  let currentConfig: IronCliwConfig;
  let lastUpdatedConfig: IronCliwConfig | null;
  ...
  beforeEach(() => {
    ...
    mocks.resolveAgentDir.mockReturnValue("/tmp/ironcliw/agents/main");
    mocks.resolveAgentWorkspaceDir.mockReturnValue("/tmp/ironcliw/workspace");
    mocks.resolveDefaultAgentWorkspaceDir.mockReturnValue("/tmp/ironcliw/workspace");
    mocks.loadValidConfigOrThrow.mockImplementation(async () => currentConfig);
    mocks.updateConfig.mockImplementation(
      async (mutator: (cfg: IronCliwConfig) => IronCliwConfig) => {
