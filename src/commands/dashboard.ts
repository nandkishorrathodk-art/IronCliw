...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set IRONCLIW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `ironcliw dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control IronCliw.");
  } else if (hint) {
    runtime.log(hint);
  }
}
