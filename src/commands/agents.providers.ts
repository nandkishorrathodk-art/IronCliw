...
function resolveDefaultAccountId(cfg: IroncliwConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: IroncliwConfig): boolean {
...
export function summarizeBindings(cfg: IroncliwConfig, bindings: AgentBinding[]): string[] {
