...
export const A2UI_PATH = "/__IronCliw__/a2ui";

export const CANVAS_HOST_PATH = "/__IronCliw__/canvas";

export const CANVAS_WS_PATH = "/__IronCliw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.IronCliwCanvasA2UIAction.postMessage(...)
  // - Android: window.IronCliwCanvasA2UIAction.postMessage(...)
  const handlerNames = ["IronCliwCanvasA2UIAction"];
  ...
  globalThis.IronCliw = globalThis.IronCliw ?? {};
  globalThis.IronCliw.postMessage = postToNode;
  globalThis.IronCliw.sendUserAction = sendUserAction;
  globalThis.IronCliwPostMessage = postToNode;
  globalThis.IronCliwSendUserAction = sendUserAction;
