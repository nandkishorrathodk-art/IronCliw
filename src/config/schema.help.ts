...
export const FIELD_HELP: Record<string, string> = {
  ...
  "talk.voiceAliases":
    'Use this legacy ElevenLabs voice alias map (for example {"ironcliw":"EXAVITQu4vr4xnSDxMaL"}) only during migration. Prefer talk.providers.elevenlabs.voiceAliases.',
  "talk.modelId":
  ...
  "browser.profiles.*.driver":
    'Per-profile browser driver mode: "ironcliw" or "extension" depending on connection/runtime strategy. Use the driver that matches your browser control stack to avoid protocol mismatches.',
  ...
  "channels.discord.eventQueue.listenerTimeout":
    "Canonical Discord listener timeout control in ms for gateway event handlers. Default is 120000 in Ironcliw; set per account via channels.discord.accounts.<id>.eventQueue.listenerTimeout.",
