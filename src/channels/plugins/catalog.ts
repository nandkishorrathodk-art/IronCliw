...
import { discoverIroncliwPlugins } from "../../plugins/discovery.js";
import type { IroncliwPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, IroncliwPackageManifest>>;
...
function toChannelMeta(params: {
  channel: NonNullable<IroncliwPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: IroncliwPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: IroncliwPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverIroncliwPlugins({ workspaceDir: options.workspaceDir });
