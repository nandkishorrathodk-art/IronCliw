...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  deleteAccount?: (params: { cfg: IroncliwConfig; accountId: string }) => IroncliwConfig;
  isEnabled?: (account: ResolvedAccount, cfg: IroncliwConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: IroncliwConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: IroncliwConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: IroncliwConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: IroncliwConfig) => ChannelAccountSnapshot;
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: IroncliwConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
