...
const TAGLINES: string[] = [
  "Your terminal just grew shield—type something and let the bot secure the busywork.",
  ...
  "Automation with shield: minimal fuss, maximal secure.",
  ...
  "shield out, commit in—let's ship something mildly responsible.",
  "I'll butter your workflow like a security shield: messy, delicious, effective.",
  "Shell yeah—I'm here to secure the toil and leave you the glory.",
  ...
  "Built by NandCliw, for humans. Don't question the hierarchy.",
  ...
  "Half butler, half debugger, fully secure.",
