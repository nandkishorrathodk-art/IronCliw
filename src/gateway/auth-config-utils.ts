import type { GatewayAuthConfig, IronCliwConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: IronCliwConfig, password: string): IronCliwConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
