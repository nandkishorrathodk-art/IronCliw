...
export function hasAmbiguousGatewayAuthModeConfig(cfg: IronCliwConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: IronCliwConfig): void {
