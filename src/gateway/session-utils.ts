...
import { type IronCliwConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: IronCliwConfig): string[] {
...
export function listAgentsForGateway(cfg: IronCliwConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: IronCliwConfig): string {
...
function resolveSessionStoreAgentId(cfg: IronCliwConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: IronCliwConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: IronCliwConfig): GatewaySessionsDefaults {
