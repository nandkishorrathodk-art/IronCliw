...
export function resolveHooksConfig(cfg: IronCliwConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: IronCliwConfig, defaultAgentId: string): Set<string> {
