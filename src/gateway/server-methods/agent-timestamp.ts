 ...
 *
 * @see https://github.com/Ironcliw/Ironcliw/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an IroncliwConfig.
 */
export function timestampOptsFromConfig(cfg: IroncliwConfig): TimestampInjectionOptions {
  return {
