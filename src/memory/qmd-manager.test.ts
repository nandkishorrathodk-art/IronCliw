...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: IroncliwConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: IroncliwConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__IroncliwMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__IroncliwMcporterColdStartWarned;
  });
