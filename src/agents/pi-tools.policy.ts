...
export function resolveSubagentToolPolicy(cfg?: IronCliwConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: IronCliwConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: IronCliwConfig["tools"];
