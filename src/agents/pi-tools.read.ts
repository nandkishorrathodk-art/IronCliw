...
function resolveAdaptiveReadMaxBytes(options?: IroncliwReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createIroncliwReadTool(base, {
...
export function createIroncliwReadTool(
  base: AnyAgentTool,
  options?: IroncliwReadToolOptions,
): AnyAgentTool {
