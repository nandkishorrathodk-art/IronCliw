...
function pickMaxBytes(cfg?: IronCliwConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  await ensureIronCliwModelsJson(effectiveCfg, params.agentDir);
