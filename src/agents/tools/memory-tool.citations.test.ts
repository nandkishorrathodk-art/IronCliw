...
function asIroncliwConfig(config: Partial<IroncliwConfig>): IroncliwConfig {
  return config as IroncliwConfig;
}

function createToolConfig() {
  return asIroncliwConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: IroncliwConfig = createToolConfig()) {
