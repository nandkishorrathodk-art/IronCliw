...
export function resolveSessionToolsVisibility(cfg: IronCliwConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: IronCliwConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: IronCliwConfig): AgentToAgentPolicy {
