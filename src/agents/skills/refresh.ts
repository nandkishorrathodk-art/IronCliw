...
function resolveWatchPaths(workspaceDir: string, config?: IronCliwConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: IronCliwConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: IronCliwConfig }) {
