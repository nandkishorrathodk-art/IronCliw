...
export const DEFAULT_SANDBOX_IMAGE = "IronCliw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "IronCliw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "IronCliw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "IronCliw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "IronCliw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "IronCliw-sandbox-browser";
