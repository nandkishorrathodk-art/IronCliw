...
function resolveAvatarSource(cfg: IronCliwConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: IronCliwConfig, agentId: string): AgentAvatarResolution {
