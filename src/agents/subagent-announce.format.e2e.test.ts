...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/IronCliw/IronCliw/issues/31298
    previousFastTestEnv = process.env.IronCliw_TEST_FAST;
  ...
  afterAll(() => {
    ...
    process.env.IronCliw_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // IronCliw_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("IronCliw runtime context (internal):");
