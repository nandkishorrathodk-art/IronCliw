...
describe("buildAgentSystemPrompt", () => {
  ...
  it("omits ACP harness guidance when ACP is disabled", () => {
    ...
    expect(prompt).toContain("- agents_list: List Ironcliw agent ids allowed for sessions_spawn");
  });
  ...
  // See: https://github.com/Ironcliw/Ironcliw/commit/66eec295b894bce8333886cfbca3b960c57c4946
  // Agents should use session_status or message timestamps to determine the date/time.
  // Related: https://github.com/Ironcliw/Ironcliw/issues/1897
  //          https://github.com/Ironcliw/Ironcliw/issues/3658
  it("does NOT include a date or time in the system prompt (cache stability)", () => {
    ...
    // https://github.com/Ironcliw/Ironcliw/issues/3658 for the preferred approach:
