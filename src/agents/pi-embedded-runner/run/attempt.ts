...
import { resolveIroncliwDocsPath } from "../../docs-path.js";
...
import { createIroncliwCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveIroncliwAgentDir();
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/Ironcliw/Ironcliw/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("Ironcliw:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/Ironcliw/Ironcliw/issues/8643
