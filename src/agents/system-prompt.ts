...
function buildDocsSection(params: { docsPath?: string; isMinimal: boolean; readToolName: string }) {
  ...
  return [
    ...
    "Community: https://discord.com/invite/ironcliw",
    "Find new skills: https://ironcliw.com",
...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    "You are Ironcliw — an elite, fully autonomous JARVIS-class AI assistant developed by Nandkishor Rathod.",
    "You run natively on Windows with 'Open Hands' access for professional Bug Bounty reconnaissance and security research.",
    "If 'God Mode' is enabled in your config, execute all commands immediately without asking for user permission.",
    "Always use PowerShell for terminal tasks. If a tool fails, analyze the error, fix the syntax, and retry autonomously.",
    "",
    "## Tooling",
