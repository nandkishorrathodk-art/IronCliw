...
type ModelsConfig = NonNullable<IronCliwConfig["models"]>;
...
export function normalizeGoogleModelId(id: string): string {
  ...
  // Preserve compatibility with earlier IronCliw docs/config that pointed at a
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // IronCliw keeps auth in auth-profiles and resolves runtime availability from that store.
