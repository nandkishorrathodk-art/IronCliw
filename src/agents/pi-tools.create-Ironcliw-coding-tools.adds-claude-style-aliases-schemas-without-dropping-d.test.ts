...
describe("createIroncliwCodingTools", () => {
  ...
  it("filters tools by sandbox policy", () => {
    const sandboxDir = path.join(os.tmpdir(), "Ironcliw-sandbox");
    const sandbox = createPiToolsSandboxContext({
      workspaceDir: sandboxDir,
      agentWorkspaceDir: path.join(os.tmpdir(), "Ironcliw-workspace"),
    ...
    const tools = createIroncliwCodingTools({ sandbox });
