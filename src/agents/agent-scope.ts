...
type AgentEntry = NonNullable<NonNullable<IronCliwConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: IronCliwConfig): AgentEntry[] {
...
export function listAgentIds(cfg: IronCliwConfig): string[] {
...
export function resolveDefaultAgentId(cfg: IronCliwConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: IronCliwConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: IronCliwConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: IronCliwConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: IronCliwConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
