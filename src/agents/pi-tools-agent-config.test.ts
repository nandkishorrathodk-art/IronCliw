...
import { createIronCliwCodingTools } from "./pi-tools.js";
...
describe("Agent-specific tool filtering", () => {
  ...
  async function withApplyPatchEscapeCase(
    ...
    try {
      ...
      const tools = createIronCliwCodingTools({
        config: cfg,
...
*** End Patch`;
  ...
  function createMainSessionTools(cfg: IronCliwConfig) {
    return createIronCliwCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
  ...
  function createMainAgentConfig(params: {
    tools: NonNullable<IronCliwConfig["tools"]>;
    agentTools?: NonNullable<NonNullable<IronCliwConfig["agents"]>["list"]>[number]["tools"];
  }): IronCliwConfig {
    return {
      tools: params.tools,
      agents: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createIronCliwCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createIronCliwCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createIronCliwCodingTools({
      config: cfg,
    ...
    const defaultTools = createIronCliwCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createIronCliwCodingTools({
      config: cfg,
    ...
    const bobTools = createIronCliwCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createIronCliwCodingTools({
      config: cfg,
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const helperTools = createIronCliwCodingTools({
      config: cfg,
