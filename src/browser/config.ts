import type { BrowserConfig, BrowserProfileConfig, IronCliwConfig } from "../config/config.js";
 ...
 *
 * Note: this is an IronCliw browser profile (routing config), not a Chrome user profile.
