...
export function listTelegramAccountIds(cfg: IronCliwConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: IronCliwConfig): string {
...
export function listEnabledTelegramAccounts(cfg: IronCliwConfig): ResolvedTelegramAccount[] {
