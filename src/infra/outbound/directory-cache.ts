...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: IronCliwConfig | null = null;
  ...
  get(key: string, cfg: IronCliwConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: IronCliwConfig): void {
    this.resetIfConfigChanged(cfg);
    const now = Date.now();
  ...
  private resetIfConfigChanged(cfg: IronCliwConfig): void {
