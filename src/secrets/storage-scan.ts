...
export function listAuthProfileStorePaths(config: IronCliwConfig, stateDir: string): string[] {
...
export function listAgentModelsJsonPaths(config: IronCliwConfig, stateDir: string): string[] {
