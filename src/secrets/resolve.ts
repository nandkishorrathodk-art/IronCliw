...
function resolveResolutionLimits(config: IronCliwConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: IronCliwConfig): SecretProviderConfig {
