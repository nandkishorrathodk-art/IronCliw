...
export async function finalizeOnboardingWizard(
    ...
    if (hatchChoice === "tui") {
      ...
      await prompter.note(
        [
          ...
          controlUiOpened
            ? "Opened in your browser. Keep that tab to control Ironcliw."
            : "Copy/paste this URL in a browser on this machine to control Ironcliw.",
          controlUiOpenHint,
        ]
          .filter(Boolean)
          .join("\n"),
  ...
  await prompter.note(
    hasWebSearchKey
      ...
      : [
          ...
          "",
          "Ironcliw uses Brave Search for the `web_search` tool. Without a Brave Search API key, web search won’t work.",
          "",
  ...
  await prompter.outro(
    controlUiOpened
      ? "Onboarding complete. Dashboard opened; keep that tab to control Ironcliw."
      : seededInBackground
