...
export type IronCliwPluginConfigSchema = {
...
export type IronCliwPluginToolContext = {
...
export type IronCliwPluginToolFactory = (
  ctx: IronCliwPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type IronCliwPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type IronCliwPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<IronCliwConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type IronCliwPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current IronCliw configuration */
  config: IronCliwConfig;
 ...
 */
export type IronCliwPluginCommandDefinition = {
...
export type IronCliwPluginHttpRouteAuth = "gateway" | "plugin";
export type IronCliwPluginHttpRouteMatch = "exact" | "prefix";

export type IronCliwPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type IronCliwPluginHttpRouteParams = {
  path: string;
  handler: IronCliwPluginHttpRouteHandler;
  auth: IronCliwPluginHttpRouteAuth;
  match?: IronCliwPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type IronCliwPluginCliContext = {
  program: Command;
  config: IronCliwConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type IronCliwPluginCliRegistrar = (ctx: IronCliwPluginCliContext) => void | Promise<void>;

export type IronCliwPluginServiceContext = {
  config: IronCliwConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type IronCliwPluginService = {
  id: string;
  start: (ctx: IronCliwPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: IronCliwPluginServiceContext) => void | Promise<void>;
};

export type IronCliwPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type IronCliwPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: IronCliwPluginConfigSchema;
  register?: (api: IronCliwPluginApi) => void | Promise<void>;
  activate?: (api: IronCliwPluginApi) => void | Promise<void>;
};

export type IronCliwPluginModule =
  | IronCliwPluginDefinition
  | ((api: IronCliwPluginApi) => void | Promise<void>);

export type IronCliwPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | IronCliwPluginToolFactory,
    opts?: IronCliwPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: IronCliwPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: IronCliwPluginHttpRouteParams) => void;
  registerChannel: (registration: IronCliwPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: IronCliwPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: IronCliwPluginService) => void;
   ...
   */
  registerCommand: (command: IronCliwPluginCommandDefinition) => void;
