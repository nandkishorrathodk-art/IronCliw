...
function mergeSignalAccountConfig(cfg: IroncliwConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: IroncliwConfig): ResolvedSignalAccount[] {
