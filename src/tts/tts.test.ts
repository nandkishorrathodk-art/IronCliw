...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.IRONCLIW_TTS_PREFS;
      process.env.IRONCLIW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.IRONCLIW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: IroncliwConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
