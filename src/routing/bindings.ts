...
export function listBindings(cfg: IronCliwConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: IronCliwConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: IronCliwConfig) {
