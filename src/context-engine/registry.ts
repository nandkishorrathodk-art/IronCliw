...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("ironcliw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: IronCliwConfig): Promise<ContextEngine> {
