...
function mergeSlackAccountConfig(cfg: IroncliwConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: IroncliwConfig): ResolvedSlackAccount[] {
