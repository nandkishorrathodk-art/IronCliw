...
function resolveAcpStreamCoalesceIdleMs(cfg: IronCliwConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: IronCliwConfig): number {
...
export function resolveAcpProjectionSettings(cfg: IronCliwConfig): AcpProjectionSettings {
