...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.IRONCLIW_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.IRONCLIW_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.IRONCLIW_SERVICE_MARKER = originalServiceMarker;
    }
  });
