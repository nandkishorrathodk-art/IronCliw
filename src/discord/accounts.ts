...
function mergeDiscordAccountConfig(cfg: IronCliwConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: IronCliwConfig): ResolvedDiscordAccount[] {
