...
describe("agent components", () => {
  const createCfg = (): IronCliwConfig => ({}) as IronCliwConfig;
...
describe("discord component interactions", () => {
  const createCfg = (): IronCliwConfig =>
    ({
      channels: {
        discord: {
          replyToMode: "first",
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/IronCliw-sessions-test.json");
  });
