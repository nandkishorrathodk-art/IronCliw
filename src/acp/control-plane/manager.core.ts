...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: IronCliwConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: IronCliwConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: IronCliwConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: IronCliwConfig }): Promise<void> {
