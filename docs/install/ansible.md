---
summary: "Automated, hardened IronCliw installation with Ansible, Tailscale VPN, and firewall isolation"
read_when:
...
5. **IronCliw** (host-based, not containerized)
...
1. **Onboarding wizard**: Configure IronCliw settings
...
The Ansible installer sets up IronCliw for manual updates. See [Updating](/install/updating) for the standard update flow.
