---
summary: "Run IronCliw in a sandboxed macOS VM (local or hosted) when you need isolation or iMessage"
read_when:
  - You want IronCliw isolated from your main macOS environment
...
# IronCliw on macOS VMs (Sandboxing)
...
Run IronCliw in a sandboxed macOS VM on your existing Apple Silicon Mac using [Lume](https://cua.ai/docs/lume).
...
This is the killer feature of running on macOS. Use [BlueBubbles](https://bluebubbles.app) to add iMessage to IronCliw.
