---
summary: "Backstory and lore of Ironcliw for context and tone"
read_when:
...
For a while, the lobster was called **Ironcliw**, living in a **Ironcliw**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:

**It molted.**

Shedding its old shell, the creature emerged anew as **Molty**, living in **Ironcliw**. But that name never quite rolled off the tongue either...

So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **Ironcliw**.
...
In the end, **Ironcliw** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.

_The crustacean known as Ironcliw had officially molted._
...
Formerly known as Ironcliw (Nov 25, 2025 - Jan 27, 2026). Molted when it was time to grow.
...
The **Moltiverse** is the community and ecosystem around Ironcliw. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at Ironcliw" to promote pump-and-dump tokens.
...
Ironcliw never quite rolled off the tongue. And so, at 4am GMT, the team gathered AGAIN.

**The Great Ironcliw Migration** began.
