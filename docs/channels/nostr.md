...
read_when:
  - You want Ironcliw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables Ironcliw to receive and respond to encrypted direct messages (DMs) via NIP-04.
