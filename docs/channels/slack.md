...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure Ironcliw HTTP mode">
...
Ironcliw supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, Ironcliw falls back to normal delivery for remaining payloads.
