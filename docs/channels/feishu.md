...
Feishu (Lark) is a team chat platform used by companies for messaging and collaboration. This plugin connects Ironcliw to a Feishu/Lark bot using the platform’s WebSocket event subscription so messages can be received without exposing a public webhook URL.
...
2. Configuring app credentials in Ironcliw
...
```json5
{
  agents: {
    list: [
      ...
      {
        id: "Ironcliw-fan",
        workspace: "/home/user/Ironcliw-fan",
        agentDir: "/home/user/.Ironcliw/agents/Ironcliw-fan/agent",
      },
      {
        id: "Ironcliw-xi",
        workspace: "/home/user/Ironcliw-xi",
        agentDir: "/home/user/.Ironcliw/agents/Ironcliw-xi/agent",
      },
    ],
  },
  bindings: [
