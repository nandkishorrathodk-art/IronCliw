---
summary: "Where IronCliw loads environment variables and the precedence order"
read_when:
...
IronCliw pulls environment variables from multiple sources. The rule is **never override existing values**.
...
IronCliw supports two env-driven patterns:
