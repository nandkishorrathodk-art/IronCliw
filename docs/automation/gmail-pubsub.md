---
summary: "Gmail Pub/Sub push wired into Ironcliw webhooks via gogcli"
read_when:
  - Wiring Gmail inbox triggers to Ironcliw
  - Setting up Pub/Sub push for agent wake
title: "Gmail PubSub"
---

# Gmail Pub/Sub -> Ironcliw

Goal: Gmail watch -> Pub/Sub push -> `gog gmail watch serve` -> Ironcliw webhook.

## Prereqs

- `gcloud` installed and logged in ([install guide](https://docs.cloud.google.com/sdk/docs/install-sdk)).
- `gog` (gogcli) installed and authorized for the Gmail account ([gogcli.sh](https://gogcli.sh/)).
- Ironcliw hooks enabled (see [Webhooks](/automation/webhook)).
