---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with IronCliw"
read_when:
  - You want Xiaomi MiMo models in IronCliw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). IronCliw uses
