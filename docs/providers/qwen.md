---
summary: "Use Qwen OAuth (free tier) in Ironcliw"
read_when:
  - You want to use Qwen with Ironcliw
...
If you already logged in with the Qwen Code CLI, Ironcliw will sync credentials
