---
summary: "Use Qianfan's unified API to access many models in IronCliw"
read_when:
...
3. IronCliw installed on your system
...
4. Copy the API key for use with IronCliw

## CLI setup

```bash
IronCliw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [IronCliw Configuration](/gateway/configuration)
