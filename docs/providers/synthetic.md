---
summary: "Use Synthetic's Anthropic-compatible API in Ironcliw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Ironcliw registers it as the
...
Note: Ironcliw's Anthropic client appends `/v1` to the base URL, so use
