...
```bash
ironcliw agent --model venice/kimi-k2-5 --message "Hello, are you working?"
```
...
```bash
ironcliw models set venice/kimi-k2-5
ironcliw models set venice/claude-opus-4-6
```
...
ironcliw agent --model venice/kimi-k2-5 --message "Quick health check"

# Use Claude Opus via Venice (anonymized)
ironcliw agent --model venice/claude-opus-4-6 --message "Summarize this task"
