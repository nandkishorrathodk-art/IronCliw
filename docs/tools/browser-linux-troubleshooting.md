---
summary: "Fix Chrome/Brave/Edge/Chromium CDP startup issues for IronCliw browser control on Linux"
...
On Ubuntu (and many Linux distros), the default Chromium installation is a **snap package**. Snap's AppArmor confinement interferes with how IronCliw spawns and monitors the browser process.
...
If you must use snap Chromium, configure IronCliw to attach to a manually-started browser:
...
You’re using the `chrome` profile (extension relay). It expects the IronCliw
