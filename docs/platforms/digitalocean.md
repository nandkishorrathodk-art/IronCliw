---
summary: "IronCliw on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up IronCliw on DigitalOcean
  - Looking for cheap VPS hosting for IronCliw
title: "DigitalOcean"
---

# IronCliw on DigitalOcean

## Goal

Run a persistent IronCliw Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
