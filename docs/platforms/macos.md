---
summary: "IronCliw macOS companion app (menu bar + gateway broker)"
read_when:
...
# IronCliw macOS Companion (menu bar + gateway broker)

The macOS app is the **menu‑bar companion** for IronCliw. It owns permissions,
...
1. Install and launch **IronCliw.app**.
...
Avoid putting your IronCliw state dir in iCloud or other cloud-synced folders.
