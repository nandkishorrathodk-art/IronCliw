---
summary: "Ironcliw on Raspberry Pi (budget self-hosted setup)"
read_when:
  - Setting up Ironcliw on a Raspberry Pi
  - Running Ironcliw on ARM devices
  - Building a cheap always-on personal AI
title: "Raspberry Pi"
---

# Ironcliw on Raspberry Pi

## Goal

Run a persistent, always-on Ironcliw Gateway on a Raspberry Pi for **~$35-80** one-time cost (no monthly fees).
...
If this Pi is mostly running Ironcliw, add a service drop-in to reduce restart
...
Most Ironcliw features work on ARM64, but some external binaries may need ARM builds:
