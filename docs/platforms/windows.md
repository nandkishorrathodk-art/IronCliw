...
read_when:
  - Installing IronCliw on Windows
...
IronCliw on Windows is recommended **via WSL2** (Ubuntu recommended). The
...
### 2) Install the IronCliw gateway user service
