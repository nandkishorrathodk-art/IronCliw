...
ditto -c -k --sequesterRsrc --keepParent dist/IronCliw.app dist/IronCliw-2026.3.9.zip

# Optional: build a styled DMG for humans (drag to /Applications)
scripts/create-dmg.sh dist/IronCliw.app dist/IronCliw-2026.3.9.dmg
...
ditto -c -k --keepParent apps/macos/.build/release/IronCliw.app.dSYM dist/IronCliw-2026.3.9.dSYM.zip
```
...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/IronCliw-2026.3.9.zip https://raw.githubusercontent.com/ironcliw/ironcliw/main/appcast.xml
```
...
- Upload `IronCliw-2026.3.9.zip` (and `IronCliw-2026.3.9.dSYM.zip`) to the GitHub release for tag `v2026.3.9`.
