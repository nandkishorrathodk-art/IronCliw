...
read_when:
  - You want Zalo Personal (unofficial) support in Ironcliw
...
Zalo Personal support for Ironcliw via a plugin, using native `zca-js` to automate a normal Zalo user account.
