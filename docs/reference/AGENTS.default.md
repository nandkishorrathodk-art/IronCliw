...
summary: "Default Ironcliw agent instructions and skills roster for the personal assistant setup"
read_when:
  - Starting a new Ironcliw agent session
  - Enabling or auditing default skills
---

# AGENTS.md — Ironcliw Personal Assistant (default)
...
If you treat this workspace as Ironcliw’s “memory”, make it a git repo (ideally private) so `AGENTS.md` and your memory files are backed up.
