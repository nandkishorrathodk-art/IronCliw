...
map_legacy_env "IRONCLIW_TAGLINE_INDEX" "IRONCLIW_TAGLINE_INDEX"
map_legacy_env "IRONCLIW_NO_ONBOARD" "IRONCLIW_NO_ONBOARD"
map_legacy_env "IRONCLIW_NO_PROMPT" "IRONCLIW_NO_PROMPT"
map_legacy_env "IRONCLIW_DRY_RUN" "IRONCLIW_DRY_RUN"
map_legacy_env "IRONCLIW_INSTALL_METHOD" "IRONCLIW_INSTALL_METHOD"
map_legacy_env "IRONCLIW_VERSION" "IRONCLIW_VERSION"
map_legacy_env "IRONCLIW_BETA" "IRONCLIW_BETA"
map_legacy_env "IRONCLIW_GIT_DIR" "IRONCLIW_GIT_DIR"
map_legacy_env "IRONCLIW_GIT_UPDATE" "IRONCLIW_GIT_UPDATE"
map_legacy_env "IRONCLIW_NPM_LOGLEVEL" "IRONCLIW_NPM_LOGLEVEL"
map_legacy_env "IRONCLIW_VERBOSE" "IRONCLIW_VERBOSE"
map_legacy_env "IRONCLIW_PROFILE" "IRONCLIW_PROFILE"
map_legacy_env "IRONCLIW_INSTALL_SH_NO_RUN" "IRONCLIW_INSTALL_SH_NO_RUN"
...
run_bootstrap_onboarding_if_needed() {
    ...
    if [[ -f "${config_path}" || -f "$HOME/.Ironcliw/Ironcliw.json" || -f "$HOME/.Ironcliw/Ironcliw.json" || -f "$HOME/.moldbot/moldbot.json" ]]; then
        return
    fi
