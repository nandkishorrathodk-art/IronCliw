...
APP_BUNDLE="${1:-dist/IronCliw.app}"
...
# Sign main binary
if [ -f "$APP_BUNDLE/Contents/MacOS/IronCliw" ]; then
  echo "Signing main binary"; sign_item "$APP_BUNDLE/Contents/MacOS/IronCliw" "$APP_ENTITLEMENTS"
fi
