...
CDP_PORT="${IRONCLIW_BROWSER_CDP_PORT:-${IRONCLIW_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${IRONCLIW_BROWSER_CDP_SOURCE_RANGE:-${IRONCLIW_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${IRONCLIW_BROWSER_VNC_PORT:-${IRONCLIW_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${IRONCLIW_BROWSER_NOVNC_PORT:-${IRONCLIW_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${IRONCLIW_BROWSER_ENABLE_NOVNC:-${IRONCLIW_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${IRONCLIW_BROWSER_HEADLESS:-${IRONCLIW_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${IRONCLIW_BROWSER_NO_SANDBOX:-${IRONCLIW_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${IRONCLIW_BROWSER_NOVNC_PASSWORD:-${IRONCLIW_BROWSER_NOVNC_PASSWORD:-}}"
