...
# Output:
# - dist/IronCliw.app
# - dist/IronCliw-<version>.zip
# - dist/IronCliw-<version>.dmg
...
APP="$ROOT_DIR/dist/IronCliw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/IronCliw-$VERSION.zip"
DMG="$ROOT_DIR/dist/IronCliw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/IronCliw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/IronCliw-$VERSION.dSYM.zip"
