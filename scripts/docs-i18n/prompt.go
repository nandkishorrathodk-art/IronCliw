...
- Keep product names in English: Ironcliw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Ironcliw Gateway, use “Gateway 网关”.
