...
| `clawdock-cli <command>`  | Run IronCliw CLI commands                      |
...
| `clawdock-cd`        | Jump to the IronCliw project directory    |
| `clawdock-config`    | Open the IronCliw config directory        |
...
2. Configure it in the IronCliw config
...
- Bash or Zsh shell
- IronCliw project (from `docker-setup.sh`)
