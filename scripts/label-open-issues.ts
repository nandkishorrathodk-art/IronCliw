...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "ironcliw", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for IronCliw. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("IronCliw Issue Label Audit");
