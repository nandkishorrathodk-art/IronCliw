...
if [[ -z "$version_content" ]]; then
  echo "<h2>Ironcliw $VERSION</h2>"
  echo "<p>Latest Ironcliw update.</p>"
  echo "<p><a href=\"https://github.com/Ironcliw/Ironcliw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
