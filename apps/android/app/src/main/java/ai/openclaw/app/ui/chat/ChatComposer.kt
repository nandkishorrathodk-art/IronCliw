...
import ai.ironcliw.app.ui.mobileSurface
import ai.ironcliw.app.ui.mobileText
import ai.ironcliw.app.ui.mobileTextSecondary
import ai.ironcliw.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.ironcliw.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.ironcliw.app.ui.mobileFontFamily,
