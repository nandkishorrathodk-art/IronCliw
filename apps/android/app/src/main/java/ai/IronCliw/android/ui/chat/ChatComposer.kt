...
import ai.IronCliw.android.ui.mobileSurface
import ai.IronCliw.android.ui.mobileText
import ai.IronCliw.android.ui.mobileTextSecondary
import ai.IronCliw.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.IronCliw.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.IronCliw.android.ui.mobileFontFamily,
