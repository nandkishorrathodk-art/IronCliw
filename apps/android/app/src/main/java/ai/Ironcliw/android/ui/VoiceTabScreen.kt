...
import ai.Ironcliw.android.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("Ironcliw is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
