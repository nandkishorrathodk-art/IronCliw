...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/IronCliw/IronCliw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/IronCliw/IronCliw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://IronCliw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "IronCliwBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "IronCliwBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "IronCliwGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "IronCliwGitCommit") as? String) ??
            "unknown"
    }
