...
enum IronCliwConfigFile {
    private static let logger = Logger(subsystem: "ai.IronCliw", category: "config")
    ...
    static func stateDirURL() -> URL {
        IronCliwPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        IronCliwPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-IronCliw-config-file",
            "event": "config.write",
