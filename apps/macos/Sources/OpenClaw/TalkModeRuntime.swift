...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.ironcliw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.ironcliw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [IronCliwChatMessage] = messages.compactMap { item in
