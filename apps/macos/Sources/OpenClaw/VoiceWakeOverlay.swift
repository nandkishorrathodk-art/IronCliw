...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.ironcliw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other IronCliw windows, but below the system’s pop-up menus.
