...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.ironcliw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return IronCliwConfigFile.defaultWorkspaceURL() }
