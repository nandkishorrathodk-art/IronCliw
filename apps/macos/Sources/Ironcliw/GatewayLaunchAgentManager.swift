...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.Ironcliw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".Ironcliw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.IroncliwCommand(
            subcommand: "gateway",
