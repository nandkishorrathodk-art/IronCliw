...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: IroncliwPhotosLatestParams) async throws -> IroncliwPhotosLatestPayload {
        ...
        var results: [IroncliwPhotoPayload] = []
        ...
        return IroncliwPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> IroncliwPhotoPayload
    {
