...
final class LiveActivityManager {
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = IronCliwActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<IronCliwActivityAttributes>.activities
    ...
    private func updateCurrent(state: IronCliwActivityAttributes.ContentState) {
    ...
    private func connectingState() -> IronCliwActivityAttributes.ContentState {
        IronCliwActivityAttributes.ContentState(
    ...
    private func idleState() -> IronCliwActivityAttributes.ContentState {
        IronCliwActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> IronCliwActivityAttributes.ContentState {
        IronCliwActivityAttributes.ContentState(
