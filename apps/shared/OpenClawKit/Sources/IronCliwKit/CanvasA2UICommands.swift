...
public enum IronCliwCanvasA2UICommand: String, Codable, Sendable {
...
public struct IronCliwCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct IronCliwCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
