        ...
        extensions: [
          {
            ...
            packageJson: {
              ...
              ironcliw: {
                install: { npmSpec: "@ironcliw/googlechat" },
                releaseChecks: {
          ...
          },
          {
            ...
            packageJson: {
              ...
              ironcliw: { install: { npmSpec: "@ironcliw/feishu" } },
            },
          },
        ],
      }),
...
describe("collectBundledExtensionManifestErrors", () => {
  it("flags invalid bundled extension install metadata", () => {
    expect(
      ...
      "bundled extension 'broken' manifest invalid | ironcliw.install.npmSpec must be a non-empty string",
    ]);
  });
  ...
  it("flags invalid release-check allowlist metadata", () => {
    expect(
      collectBundledExtensionManifestErrors([
        {
          ...
          packageJson: {
            ironcliw: {
              install: { npmSpec: "@ironcliw/broken" },
              releaseChecks: {
      ...
      "bundled extension 'broken' manifest invalid | ironcliw.releaseChecks.rootDependencyMirrorAllowlist must contain only non-empty strings",
    ]);
  });
});
